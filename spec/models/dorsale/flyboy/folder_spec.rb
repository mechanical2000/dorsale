...
describe Dorsale::Flyboy::Folder do
  ...
  it "should create tracking" do
    ...
    folder1 = FactoryGirl.create(:flyboy_folder)
    folder2 = FactoryGirl.create(:flyboy_folder)
    folder3 = FactoryGirl.create(:flyboy_folder)
  ...
  describe "#progress" do
    it "update task should update folder progress" do
      folder  = FactoryGirl.create(:flyboy_folder)
      task1 = FactoryGirl.create(:flyboy_task, taskable: folder, progress: 50)
      task2 = FactoryGirl.create(:flyboy_task, taskable: folder, progress: 100)
  ...
  describe "states" do
    ...
    it "open folder with undone tasks can't be closed" do
      folder = FactoryGirl.create(:flyboy_folder, status: "open")
      task = FactoryGirl.create(:flyboy_task, taskable: folder, done: false)
    ...
    it "open folder with all tasks done can be closed" do
      folder = FactoryGirl.create(:flyboy_folder, status: "open")
      task = FactoryGirl.create(:flyboy_task, taskable: folder, done: true)
      expect(folder.close).to be true
      expect(folder.status).to eq "closed"
    end
