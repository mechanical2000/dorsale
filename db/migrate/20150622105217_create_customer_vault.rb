class CreateCustomerVault < ActiveRecord::Migration
  def change
    ...
    add_index :customer_vault_links, :alice_id
    add_index :customer_vault_links, :alice_type
    add_index :customer_vault_links, :bob_id
    add_index :customer_vault_links, :bob_type
  end
end
